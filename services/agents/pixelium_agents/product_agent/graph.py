"""Product Agent LangGraph: Router -> [Search ∥ Filter] -> Rank | Cart Builder."""
from __future__ import annotations

from langgraph.graph import END, START, StateGraph

from .nodes import parallel_search, route_action, router, sub_cart_builder
...
def build_product_agent():
    ...
    g.add_conditional_edges(
        "router", route_action,
        {"search": "parallel_search", "build_cart": "build_cart"},
    )
